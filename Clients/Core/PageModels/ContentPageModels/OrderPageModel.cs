...
namespace NotatnikMechanika.Core.PageModels
{
    ...
    public class OrderPageModel : PageModelBase
    {
        ...
        {
            CommodityModel commodity = (CommodityModel)sender;
        ...
        {
            ServiceModel service = (ServiceModel)sender;
        ...
        {
            IsLoading = true;
            OrderExtendedModel order = await _httpRequestService.SendGet<OrderExtendedModel>(OrderPaths.Extended(Parameter ?? 0));
            ...
            List<ServiceModel> services = await _httpRequestService.SendGet<List<ServiceModel>>(ServicePaths.ByOrder(OrderModel.Id));
            ...
            List<CommodityModel> commodities = await _httpRequestService.SendGet<List<CommodityModel>>(CommodityPaths.ByOrder(OrderModel.Id));
